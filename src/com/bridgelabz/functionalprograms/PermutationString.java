...
public class PermutationString {
	...
	/*
	 * The main function is written to take input from the user and call permute
	 * function that compares the permutation resulted by two methods
	 */
	public static void main(String[] args) {
		...
		// Method 1- using static function of FunctionalUtilty class of
		// com.bridgelabz.util package
		List<String> arr1 = FunctionalLogic.recursion(str, 0, len, arr);
		System.out.println(arr1);
		System.out.println("recursion size is: " + arr1.size());
		System.out.println("array after sorting :");
		arr1 = FunctionalLogic.listSort(arr1);
		System.out.println(arr1);

		System.out.println("--------------------------------------------------------------------------------");
		System.out.println("iteration of a string is ");

		// Method 2- using static function of FunctionalUtilty class of
		// com.bridgelabz.util package
		List<String> arr2 = FunctionalLogic.iteration(str);

		System.out.println(arr2);
		System.out.println("iteration size is: " + arr2.size());
		System.out.println("array after sorting :");
		arr2 = FunctionalLogic.listSort(arr2);
		System.out.println(arr2);
		System.out.println();
		int flag = 1;
